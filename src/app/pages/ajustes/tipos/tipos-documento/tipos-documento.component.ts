...
export class TiposDocumentoComponent implements OnInit {
  ...
  ListarDocumentos() {
    this.http.get(environment.base_url + 'php/recursos_humanos/lista_servicios.php').subscribe((data: any) => {
      this.Tipos_Documento = data.Lista;
  ...
  EditarDocumento(pos){
    ...
    this.Hoja.Codigo=this.Tipos_Documento[pos].Codigo;
    this.Hoja.Nombre=this.Tipos_Documento[pos].Nombre;
